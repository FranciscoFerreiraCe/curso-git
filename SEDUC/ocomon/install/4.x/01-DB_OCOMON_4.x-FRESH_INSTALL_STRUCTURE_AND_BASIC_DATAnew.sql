...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`ocomon` /*!40100 DEFAULT CHARACTER SET utf8 */;

CREATE USER 'seduc'@'localhost' IDENTIFIED BY 'Sme@Sga9090';
GRANT SELECT , INSERT , UPDATE , DELETE ON `seduc` . * TO 'seduc'@'localhost';
GRANT Drop ON seduc.* TO 'seduc'@'localhost';
FLUSH PRIVILEGES;
